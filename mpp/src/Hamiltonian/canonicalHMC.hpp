...
namespace mpp{ namespace Hamiltonian{
     ...
     */
    template<class _potEngyType,class _kinEngyType,class _randVarGenType,class _integrationPolicy>
    class canonicalHMC
    {
    public:

        typedef _potEngyType potEngyType;
        typedef _kinEngyType kinEngyType;
        typedef _integrationPolicy integrationPolicy;
        typedef _randVarGenType randVarGenType;

        typedef typename potEngyType::realScalarType realScalarType;
        ...
        typedef typename _kinEngyType::realScalarType realScalarTypeTypeKE;
        ...
        canonicalHMC(realScalarType const maxEps,size_t const maxNumSteps,
            potEngyType & G,kinEngyType & K)
        :m_maxEps(maxEps),m_maxNumSteps(maxNumSteps),m_G(G),m_K(K)
        {
            ...
            randVarGenType & rvGen)
        {
            ...
            while(samp < numSamples)
            {
                ...
                realScalarType u = rvGen.uniform();
